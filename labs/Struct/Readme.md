...
## Success Criteria
Your `Temperature` struct should:
- Have properties for C, F, and K with proper getters and setters
- Implement conversion formulas correctly: K = C + 273.15; F = (C * 9.0/5.0) + 32.0
- Include constructor accepting a parameter for initialization
- Support the bonus challenge (constructor with parameter)

## Where to find the solution
See [solutions/Struct](../../solutions/Struct)
## Instructions
