...
- Define `TemperatureScale` enum with CELSIUS, FAHRENHEIT, and KELVIN values
- Add a scale parameter to Temperature constructor with CELSIUS as default
- Support creating Temperature objects with different scales
- Pass all scale-based temperature operations correctly

## Where to find the solution
See [solutions/Enum](../../solutions/Enum)
